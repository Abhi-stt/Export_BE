...
async function assignTasksToExistingOrders() {
  try {
    console.log('🚀 Assigning tasks to existing shipment orders...');
        ...
        if (!existingAssignment) {
          ...
          if (suitableForwarder) {
            ...
            assignment.assignedForwarders.push({
              ...
              dueDate: dueDate,
              priority: 'medium',
              estimatedDuration: stageMapping.duration * 24, // Convert to hours
